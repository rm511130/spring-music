...
This is a sample application for using database services on [Cloud Foundry](http://cloudfoundry.org) with the [Spring Framework](http://spring.io), [Spring Boot](http://projects.spring.io/spring-boot/) and [Spring Actuators](https://docs.pivotal.io/pivotalcf/2-4/console/spring-boot-actuators.html).
